                 ...
                 <a href="index.php?deleted_payment" class="btn btn-danger" role="button">Delete Payments</a> 
                            ...
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                <thead>
                                    ...
                                    <?php
                                   $i=0;
                                   $get_payment="SELECT * FROM payments Where status='Delete Payment'";
                                  // $pending_payment="SELECT * FROM customer_order Where payment_status='Delete Payment'";
                                  // $run_pending_payment=mysqli_query($con, $pending_payment);
